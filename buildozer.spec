...
title = Freestyle Trainer

# (str) Package name
package.name = FreestyleTrainer
...
source.include_exts = py,png,jpg,kv,atlas,sqlite,json,wav,ogg,mp3,txt,sql
...
requirements = python3,kivy,jnius,sqlite3,plyer
...
android.permissions = INTERNET, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE, READ_MEDIA_AUDIO, READ_MEDIA_VIDEO
...
ios.ios_deploy_url = https://cocomarck.github.io/jean-abraham/
